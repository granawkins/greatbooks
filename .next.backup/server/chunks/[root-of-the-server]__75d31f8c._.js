...
`);try{a.exec("ALTER TABLE chapters ADD COLUMN source_chapter_id INTEGER")}catch{}try{a.exec("ALTER TABLE chapters ADD COLUMN chapter_type TEXT DEFAULT 'text'")}catch{}e.s(["db",0,{getBooks:e=>e?s.prepare("SELECT * FROM books WHERE type = ?").all(e):s.prepare("SELECT * FROM books").all(),getBook:e=>s.prepare("SELECT * FROM books WHERE id = ?").get(e),getChapters:e=>s.prepare("SELECT * FROM chapters WHERE book_id = ? ORDER BY number").all(e),getChapter:(e,t)=>s.prepare("SELECT * FROM chapters WHERE book_id = ? AND number = ?").get(e,t),getSegments:e=>{let t=s.prepare("SELECT source_chapter_id FROM chapters WHERE id = ?").get(e),r=t?.source_chapter_id??e;return s.prepare("SELECT * FROM segments WHERE chapter_id = ? ORDER BY sequence").all(r)},getSourceBookInfo:(e,t)=>{let r=s.prepare("SELECT source_chapter_id FROM chapters WHERE book_id = ? AND number = ?").get(e,t);if(!r?.source_chapter_id)return null;let a=s.prepare("SELECT book_id, number FROM chapters WHERE id = ?").get(r.source_chapter_id);return a?{bookId:a.book_id,chapterNumber:a.number}:null},getResolvedChapter:e=>{let t=s.prepare("SELECT * FROM chapters WHERE id = ?").get(e);if(t){if(t.source_chapter_id){let e=s.prepare("SELECT * FROM chapters WHERE id = ?").get(t.source_chapter_id);if(e)return{...t,audio_file:e.audio_file,audio_duration_ms:e.audio_duration_ms}}return t}},upsertUser:e=>{a.prepare("INSERT OR IGNORE INTO users (id) VALUES (?)").run(e)},getUser:e=>s.prepare("SELECT * FROM users WHERE id = ?").get(e),getUserByEmail:e=>s.prepare("SELECT * FROM users WHERE email = ?").get(e),updateUserEmail:(e,t)=>{a.prepare("UPDATE users SET email = ? WHERE id = ?").run(t,e)},updatePlaybackSpeed:(e,t)=>{a.prepare("UPDATE users SET playback_speed = ? WHERE id = ?").run(t,e)},getProgress:e=>s.prepare("SELECT * FROM user_progress WHERE user_id = ? ORDER BY updated_at DESC").all(e),getProgressWithBooks:e=>s.prepare(`SELECT p.*, b.title, b.author, b.type
         ...
         ON CONFLICT (user_id, book_id) DO UPDATE SET
           ...
           updated_at = excluded.updated_at`).run(e,t,r,s)},getMessages:(e,t)=>s.prepare("SELECT * FROM messages WHERE user_id = ? AND book_id = ? ORDER BY id").all(e,t),insertMessage:(e,t,r,s,o="completed",i=null)=>a.prepare("INSERT INTO messages (user_id, book_id, role, text, status, model) VALUES (?, ?, ?, ?, ?, ?) RETURNING *").get(e,t,r,s,o,i),getBookStats:()=>s.prepare(`SELECT c.book_id,
         ...
         GROUP BY c.book_id`).all(),updateMessage:(e,t,r)=>{a.prepare("UPDATE messages SET text = ?, status = ? WHERE id = ?").run(t,r,e)},getAnnotations:(e,t,r)=>a.prepare("SELECT * FROM annotations WHERE user_id = ? AND book_id = ? AND chapter_number = ? ORDER BY id").all(e,t,r),insertAnnotation:(e,t,r,s,o,i,n,d,u="yellow",p=null)=>a.prepare(`INSERT INTO annotations
          (user_id, book_id, chapter_number, start_segment_seq, start_char, end_segment_seq, end_char, type, color, comment_text)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?) RETURNING *`).get(e,t,r,s,o,i,n,d,u,p),updateAnnotationComment:(e,t,r)=>a.prepare("UPDATE annotations SET comment_text = ? WHERE id = ? AND user_id = ?").run(r,e,t).changes>0,deleteAnnotation:(e,t)=>a.prepare("DELETE FROM annotations WHERE id = ? AND user_id = ?").run(e,t).changes>0,extendOrCreateSession:(e,t,r,s,o)=>{if(o<=0)return;let i=a.prepare(`SELECT id, ended_at FROM user_sessions
         WHERE user_id = ? AND book_id = ? AND chapter_number = ? AND mode = ?
         ORDER BY ended_at DESC LIMIT 1`).get(e,t,r,s);i&&(Date.now()-new Date(i.ended_at+"Z").getTime())/1e3<30?a.prepare(`UPDATE user_sessions
           SET duration_ms = duration_ms + ?, ended_at = datetime('now')
           WHERE id = ?`).run(o,i.id):a.prepare(`INSERT INTO user_sessions (user_id, book_id, chapter_number, mode, duration_ms)
      ...
      `).all(e),getEnrolledCourseForBook:(e,t)=>{let r=s.prepare(`
        ...
        WHERE b.type = 'course' AND sc.book_id = ?
        LIMIT 1
      `).get(e,t);return r?{courseId:r.course_id,courseTitle:r.course_title,currentCourseChapter:r.chapter_number}:null}}])},61066,e=>{"use strict";var t=e.i(47909),r=e.i(74017),s=e.i(96250),a=e.i(59756),o=e.i(61916),i=e.i(74677),n=e.i(69741),d=e.i(16795),u=e.i(87718),p=e.i(95169),E=e.i(47587),c=e.i(66012),l=e.i(70101),_=e.i(26937),R=e.i(10372),T=e.i(93695);e.i(52474);var N=e.i(220),h=e.i(89171),m=e.i(79832),O=e.i(43793);async function g(e){let t=await (0,m.getAuthUserId)();if(!t)return h.NextResponse.json({listen_ms:0,read_ms:0});let r=e.nextUrl.searchParams.get("month")??void 0,s=O.db.getUserUsageSummary(t,r);return h.NextResponse.json(s)}e.s(["GET",()=>g],27032);var b=e.i(27032);let C=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/user/usage/route",pathname:"/api/user/usage",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/api/user/usage/route.ts",nextConfigOutput:"",userland:b}),{workAsyncStorage:x,workUnitAsyncStorage:L,serverHooks:A}=C;function S(){return(0,s.patchFetch)({workAsyncStorage:x,workUnitAsyncStorage:L})}async function U(e,t,s){C.isDev&&(0,a.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let h="/api/user/usage/route";h=h.replace(/\/index$/,"")||"/";let m=await C.prepare(e,t,{srcPage:h,multiZoneDraftMode:!1});if(!m)return t.statusCode=400,t.end("Bad Request"),null==s.waitUntil||s.waitUntil.call(s,Promise.resolve()),null;let{buildId:O,params:g,nextConfig:b,parsedUrl:x,isDraftMode:L,prerenderManifest:A,routerServerContext:S,isOnDemandRevalidate:U,revalidateOnlyGenerated:I,resolvedPathname:k,clientReferenceManifest:D,serverActionsManifest:f}=m,y=(0,n.normalizeAppPath)(h),v=!!(A.dynamicRoutes[y]||A.routes[k]),M=async()=>((null==S?void 0:S.render404)?await S.render404(e,t,x,!1):t.end("This page could not be found"),null);if(v&&!L){let e=!!A.routes[k],t=A.dynamicRoutes[y];if(t&&!1===t.fallback&&!e){if(b.experimental.adapterPath)return await M();throw new T.NoFallbackError}}let w=null;!v||C.isDev||L||(w="/index"===(w=k)?"/":w);let F=!0===C.isDev||!v,H=v&&!F;f&&D&&(0,i.setManifestsSingleton)({page:h,clientReferenceManifest:D,serverActionsManifest:f});let P=e.method||"GET",q=(0,o.getTracer)(),W=q.getActiveScopeSpan(),B={params:g,prerenderManifest:A,renderOpts:{experimental:{authInterrupts:!!b.experimental.authInterrupts},cacheComponents:!!b.cacheComponents,supportsDynamicResponse:F,incrementalCache:(0,a.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:b.cacheLife,waitUntil:s.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,s,a)=>C.onRequestError(e,t,s,a,S)},sharedContext:{buildId:O}},X=new d.NodeNextRequest(e),G=new d.NodeNextResponse(t),j=u.NextRequestAdapter.fromNodeNextRequest(X,(0,u.signalFromNodeResponse)(t));try{let i=async e=>C.handle(j,B).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=q.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==p.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let s=r.get("next.route");if(s){let t=`${P} ${s}`;e.setAttributes({"next.route":s,"http.route":s,"next.span_name":t}),e.updateName(t)}else e.updateName(`${P} ${h}`)}),n=!!(0,a.getRequestMeta)(e,"minimalMode"),d=async a=>{var o,d;let u=async({previousCacheEntry:r})=>{try{if(!n&&U&&I&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let o=await i(a);e.fetchMetrics=B.renderOpts.fetchMetrics;let d=B.renderOpts.pendingWaitUntil;d&&s.waitUntil&&(s.waitUntil(d),d=void 0);let u=B.renderOpts.collectedTags;if(!v)return await (0,c.sendResponse)(X,G,o,B.renderOpts.pendingWaitUntil),null;{let e=await o.blob(),t=(0,l.toNodeOutgoingHttpHeaders)(o.headers);u&&(t[R.NEXT_CACHE_TAGS_HEADER]=u),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==B.renderOpts.collectedRevalidate&&!(B.renderOpts.collectedRevalidate>=R.INFINITE_CACHE)&&B.renderOpts.collectedRevalidate,s=void 0===B.renderOpts.collectedExpire||B.renderOpts.collectedExpire>=R.INFINITE_CACHE?void 0:B.renderOpts.collectedExpire;return{value:{kind:N.CachedRouteKind.APP_ROUTE,status:o.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:s}}}}catch(t){throw(null==r?void 0:r.isStale)&&await C.onRequestError(e,t,{routerKind:"App Router",routePath:h,routeType:"route",revalidateReason:(0,E.getRevalidateReason)({isStaticGeneration:H,isOnDemandRevalidate:U})},!1,S),t}},p=await C.handleResponse({req:e,nextConfig:b,cacheKey:w,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:A,isRoutePPREnabled:!1,isOnDemandRevalidate:U,revalidateOnlyGenerated:I,responseGenerator:u,waitUntil:s.waitUntil,isMinimalMode:n});if(!v)return null;if((null==p||null==(o=p.value)?void 0:o.kind)!==N.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==p||null==(d=p.value)?void 0:d.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});n||t.setHeader("x-nextjs-cache",U?"REVALIDATED":p.isMiss?"MISS":p.isStale?"STALE":"HIT"),L&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let T=(0,l.fromNodeOutgoingHttpHeaders)(p.value.headers);return n&&v||T.delete(R.NEXT_CACHE_TAGS_HEADER),!p.cacheControl||t.getHeader("Cache-Control")||T.get("Cache-Control")||T.set("Cache-Control",(0,_.getCacheControlHeader)(p.cacheControl)),await (0,c.sendResponse)(X,G,new Response(p.value.body,{headers:T,status:p.value.status||200})),null};W?await d(W):await q.withPropagatedContext(e.headers,()=>q.trace(p.BaseServerSpan.handleRequest,{spanName:`${P} ${h}`,kind:o.SpanKind.SERVER,attributes:{"http.method":P,"http.target":e.url}},d))}catch(t){if(t instanceof T.NoFallbackError||await C.onRequestError(e,t,{routerKind:"App Router",routePath:y,routeType:"route",revalidateReason:(0,E.getRevalidateReason)({isStaticGeneration:H,isOnDemandRevalidate:U})},!1,S),v)throw t;return await (0,c.sendResponse)(X,G,new Response(null,{status:500})),null}}e.s(["handler",()=>U,"patchFetch",()=>S,"routeModule",()=>C,"serverHooks",()=>A,"workAsyncStorage",()=>x,"workUnitAsyncStorage",()=>L],61066)}];

//# sourceMappingURL=%5Broot-of-the-server%5D__75d31f8c._.js.map